<html direction="rtl" dir="rtl" style="direction: rtl" >
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" src="{{ asset('cp/assets/media/logos/logo-letter-9.png') }}" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
...
{{--								<div class="symbol symbol-50 symbol-light mr-5">--}}
{{--									<span class="symbol-label">--}}
{{--										<img src="{{ asset('cp/assets/media/svg/misc/005-bebo.svg') }}" class="h-50 align-self-center" alt="" />--}}
{{--									</span>--}}
{{--								</div>--}}
{{--								<div class="d-flex flex-column flex-grow-1 mr-2">--}}
...
{{--								<div class="symbol symbol-50 symbol-light mr-5">--}}
{{--									<span class="symbol-label">--}}
{{--										<img src="{{ asset('cp/assets/media/svg/misc/014-kickstarter.svg') }}" class="h-50 align-self-center" alt="" />--}}
{{--									</span>--}}
{{--								</div>--}}
{{--								<div class="d-flex flex-column flex-grow-1 mr-2">--}}
									...
									<div class="d-flex flex-column mb-5 align-items-start">
										<div class="d-flex align-items-center">
											<div class="symbol symbol-circle symbol-40 mr-3">
												<img alt="Pic" src="{{ asset('cp/assets/media/users/300_12.jpg') }}" />
											</div>
											<div>
									...
									<div class="d-flex flex-column mb-5 align-items-end">
										<div class="d-flex align-items-center">
											...
											<div class="symbol symbol-circle symbol-40 ml-3">
												<img alt="Pic" src="{{ asset('cp/assets/media/users/300_21.jpg') }}" />
											</div>
										</div>
